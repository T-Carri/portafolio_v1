    ...
    <div className="md:hidden" id="mobile-menu">
      ...
      <div className="border-t border-gray-700 pb-3 pt-4">
        <div className="flex items-center px-5">
          ...
          <div className="ml-3">
            <div className="text-base font-medium leading-none text-white">Bryan Carrillo</div>
            <div className="text-sm font-medium leading-none text-gray-400">cocleas87@gmail.com</div>
          </div>
